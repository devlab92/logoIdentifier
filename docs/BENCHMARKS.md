...
| 2026-09-10 | phase07+ | 561/1198 | ocr+sift+emb (calibrated) | 0.540 | 0.973 | 9.6% | cached | **current baseline.** 1,759 images after the near-miss harvest: 19 more logos found among the 423 images closest to the review line, plus 404 confirmed hard negatives (D-036). Bands: emb 0.85/0.90, ocr 0.65/0.75, sift weak=strong=0.30. Confusion pos 537/9/15, neg 457/159/582; wins ocr=920 emb=204 sift=38. **GATE PASSED.** Chosen over the previous thresholds, which on this same set give precision 0.578 but catch-recall 0.959 - below target - and lose 23 logos instead of 15. Precision stays low because this set is almost entirely boundary cases; the review budget was swept from 10% to 50% and the human workload is **identical (1,162 images) at every setting**, so the cap sorts work rather than reducing it, and stays at 10% |
