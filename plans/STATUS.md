...
| phase07 hardening + THE RUN | done | 2026-09-08 | 1f2a17d + 2fe7668 | resume journal, SHA-256 + dHash dedup, crops/detected/review, errors.csv, `--restart`/`--no-artifacts`, 269 tests. **Full collection scanned: 3,370 images, 2 h 06 m, 0 errors, 24.3% duplicates.** No multiprocessing: measured ETA(10k) 6 h 18 m, under the 12 h bar |
